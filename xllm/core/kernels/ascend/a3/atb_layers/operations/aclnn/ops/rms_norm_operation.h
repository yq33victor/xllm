 ...
 */
#ifndef ATB_SPEED_PLUGIN_ACLNN_RMSNORM_OPERATION_V2_H
#define ATB_SPEED_PLUGIN_ACLNN_RMSNORM_OPERATION_V2_H
...
/// addNormNode.operation = new atb_speed::common::RmsNormOperation("AddRmsNormNode",  param.rmsNormEps);
