    ...
    const DecoderLayerParam &param)
{
    ...
    latentAttentionParam.lcocAttnTpBackend = param.mapping.Get(base::LCOC_ATTN_TP).backend;
    latentAttentionParam.lcocAttnTpDomain = param.mapping.Get(base::ATTN_TP).commDomain;
    latentAttentionParam.lcocHcclComm = param.mapping.Get(base::ATTN_TP).hcclComm;
    return atb::NO_ERROR;
}
